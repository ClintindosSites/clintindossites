...
export default function ManutencaoPC() {
  const servicos = [
    ...
    "Troca de peças e otimização de desempenho",
  ];

  const mensagem =
    "Olá, preciso de manutenção no meu computador desktop. Gostaria de solicitar um orçamento e entender como funciona o atendimento.";
  ...
  return (
    <section className="py-24 px-6" id="manutencaoComputador">
            ...
            <div>
              <div className="flex flex-col gap-[10px] my-[20px]">
                ...
                <h2 className="text-4xl md:text-5xl font-extrabold text-white leading-tight mb-6">
                  Computador lento, travando ou com defeito?
                </h2>

                <p className="text-[#cfcfcf] text-[17px] leading-relaxed mb-8">
                  Realizamos manutenção completa em computadores desktop com
                  diagnóstico rápido, atendimento em Belo Horizonte e Contagem e
                  suporte especializado. Deixe seu computador mais rápido,
                  seguro e funcionando como novo.
                </p>
              </div>
              ...
              <div className="flex justify-between mb-10 infoService">
                ...
                <div className="relative">
                  ...
                  <img
                    src="/assets/manutencao-pc.webp"
                    alt="Manutenção de Computadores em Belo Horizonte"
                    className="
                      relative z-10
                      w-full
                      h-[300px]
                  ...
                  <Link
                    ...
                    target="_blank"
                    href={whatsappUrl}
                    onClick={() => reportConversion("Manutenção de Computador")}
                  >
