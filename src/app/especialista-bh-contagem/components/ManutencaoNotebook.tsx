...
export default function ManutencaoNotebook() {
  ...
  const mensagem =
    "Olá, preciso de manutenção no meu notebook. Gostaria de solicitar um orçamento e entender como funciona o atendimento.";
              ...
              <div className="flex justify-between mb-10 infoService">
                ...
                <div className="relative">
                  ...
                  <Link
                    ...
                    target="_blank"
                    href={whatsappUrl}
                    onClick={() => reportConversion("Manutenção de Notebook")}
                  >
